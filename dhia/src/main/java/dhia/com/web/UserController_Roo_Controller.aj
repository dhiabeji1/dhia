...
import dhia.com.web.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    @Autowired
    ServiceUsers UserController.serviceUsers;
    ...
    public String UserController.show(@PathVariable("id") BigInteger id, Model uiModel) {
        ...
        uiModel.addAttribute("users", serviceUsers.findUsers(id));
    ...
    public String UserController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("userses", serviceUsers.findUsersEntries(firstResult, sizeNo));
            float nrOfPages = (float) serviceUsers.countAllUserses() / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("userses", serviceUsers.findAllUserses());
        }
        addDateTimeFormatPatterns(uiModel);
        return "userses/list";
    }
    ...
    public String UserController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, serviceUsers.findUsers(id));
        return "userses/update";
    }
    ...
    public String UserController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Users users = serviceUsers.findUsers(id);
        serviceUsers.deleteUsers(users);
        uiModel.asMap().clear();
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        ...
        uiModel.addAttribute("users_created_at_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
